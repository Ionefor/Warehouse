...
public class GetProductsWithPaginationHandler :
    IQueryHandler<PageList<ProductDto>, GetProductsWithPaginationQuery>
{
    private readonly IReadDbContext _context;
    private readonly IDatabase _redis;
    
    public GetProductsWithPaginationHandler(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return JsonSerializer.Deserialize<PageList<ProductDto>>(cachedData);
        }
        
        var products = _context.Products.
            Where(p => p.Category == query.Category);
        
        var result =  await products.ToPagedList(
